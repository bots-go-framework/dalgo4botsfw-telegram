module github.com/bots-go-framework/dalgo4botsfw-telegram
...
require (
	github.com/bots-go-framework/bots-fw-telegram v0.6.8
	github.com/bots-go-framework/bots-fw-telegram-models v0.0.7
	github.com/dal-go/dalgo v0.2.28
)

require (
	github.com/bots-go-framework/bots-api-telegram v0.3.0 // indirect
	github.com/bots-go-framework/bots-fw v0.16.8 // indirect
